...
public class TestMD5Decode { //正则表达式，用于匹配  
    ...
    public static void main(String[] args) {
		String src="b59c67bf196a4758191e42f76670ceba";
		String key="SecretKey_NCS_Co.,Ltd.";
		String out=TestMD5Decode.decode(src, key);
